...
public class BoardMain {
	...
	private void lookBoard() {
		...
		int board$No = scan.nextInt();
		
		BoardVO tmp = service.getBoard(board$No);
		
		System.out.println();
		System.out.println("번   호 : " + tmp.getBoard_no());
		System.out.println("제   목 : " + tmp.getBoard_title());
		System.out.println("작성자 : " + tmp.getBoard_writer());
		System.out.println("내   용 : " + tmp.getBoard_content());
		System.out.println("날   짜 : " + tmp.getBoard_date());
		System.out.println();
	}
