...
/**
 * ProdVO의 SQL문 수행결과를 service에 전달하는 DAO interface
 * @author 김윤주
 * @since 2018.06.28
 * @version 1.0
 */
public interface IProdDao {
	 ...
	 * @return List<ProdVO> 물품 객체를 담고있는 List
	 */
	public List<ProdVO> selectProdAll();
	
	/**
	 * ProdVO에 담긴 물품 정보를 DB에 insert하는 메서드
	 * @param pv insert할 정보가 담긴 물품 객체
	 * @return DB에 insert 성공하면 1 이상의 값이 반환, 실패하면 0이 반환
	 */
	public int insertProd(ProdVO pv);
	
	/**
	 * ProdVO에 담긴 물품 정보를 DB에 update하는 메서드
	 * @param pv update할 정보가 담긴 물품 객체
	 ...
	 * @param prod_id 물품 ID
	 * @return 해당 물품이 있으면 true, 없으면 false
	 */
