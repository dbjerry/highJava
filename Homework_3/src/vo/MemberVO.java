...
public class MemberVO {
	...
	private String mem_regno1; // 주민번호 앞자리
	private String mem_regno2; // 주민번호 뒷자리
	private String mem_bir; // 생일(YY/MM/DD)
	private String mem_zip; // 우편번호
	private String mem_add1; // 주소
	private String mem_add2; // 상세주소
	private String mem_hometel; // 집 전화번호
	private String mem_comtel; // 직장 전화번호
	private String mem_hp; // 핸드폰 번호
	private String mem_mail; // 이메일
	private String mem_job; // 직업
	private String mem_like; // 취미
	private String mem_memorial; // 기념일
	private String mem_memorialday; // 기념일 날짜(YY/MM/DD)
	private String mem_mileage; // 마일리지
	private String mem_delete; // 탈퇴여부
